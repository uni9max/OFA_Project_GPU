...
class OFATask(FairseqTask):
    ...
    def setup_task(cls, cfg: DictConfig, **kwargs):
        ...
        # % Fallback fix: if cfg.bpe_dir is None, set it manually
        if cfg.bpe_dir is None:
            print("WARNING: cfg.bpe_dir is None. Setting fallback path manually.")
            cfg.bpe_dir = "../../utils/BPE"
